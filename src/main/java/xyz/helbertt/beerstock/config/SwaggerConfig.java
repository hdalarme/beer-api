package xyz.helbertt.beerstock.config;
...
public class SwaggerConfig {
    ...
    private static final String BASE_PACKAGE = "xyz.helbertt.beerstock.controller";
    ...
    private static final String CONTACT_GITHUB = "https://gtihub.com/hdalarme";
